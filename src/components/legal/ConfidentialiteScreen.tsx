...
/**
 * Politique de confidentialite - transcription de bacchana-content/legal/politique-confidentialite.md (v1.14.0).
  ...
  return (
    <LegalLayout title="Politique de confidentialité" version="Version applicable au 4 août 2026">
      ...
      <LegalSection title="2. Données collectées et bases légales">
        <p>
          Bacchana fonctionne <strong>sans création de compte</strong> : aucun identifiant, aucun mot de passe et
        ...
        <p>
          ...
          politiques ou religieuses.</strong> Bacchana n&apos;est pas destiné aux mineurs (voir section 9) et ne
      ...
      <LegalSection title="3. Sous-traitants et destinataires des données">
        ...
        />
        <p>
          <strong>Supabase</strong> est envisagé dans l&apos;architecture cible pour une éventuelle distribution
      ...
      <LegalSection title="5. Durées de conservation - synthèse">
        <ul className="list-disc pl-5 space-y-1">
          <li><strong>Données de partie (prénoms des joueurs)</strong> : jamais transmises aux serveurs de l&apos;éditeur, donc aucune conservation côté Bacchana.</li>
      ...
      <LegalSection title="7. Effacement des données et désinstallation">
        <p>
          Bacchana ne proposant <strong>pas de compte utilisateur</strong>, il n&apos;existe pas de fonctionnalité
      ...
      <LegalSection title="8. Cookies et traceurs">
        <p>Le site web et l&apos;application Bacchana utilisent :</p>
        <ul className="list-disc pl-5 space-y-1">
          <li>
      ...
      <LegalSection title="9. Public concerné et mineurs">
        <p>
          Bacchana est un jeu destiné à un public adulte, <strong>réservé aux personnes de 18 ans ou plus</strong>.
          La classification d&apos;âge technique d&apos;Apple, plafonnée à 17+ (palier maximal de son
          référentiel), n&apos;abaisse pas cette exigence propre à Bacchana. Le service n&apos;est pas destiné aux
      ...
      <LegalSection title="10. Sécurité des données">
        <p>
          ...
          aucun stockage de donnée de carte bancaire côté Bacchana, stockage des données de partie exclusivement
      ...
      <LegalSection title="11. Modification de la politique de confidentialité">
        <p>
          ...
          réglementation, notamment en cas d&apos;activation future de Supabase. La date de dernière mise à jour
