    ...
    <LegalLayout title="Politique de confidentialité" version="Version applicable au 1er août 2026">
      <LegalSection title="1. Responsable de traitement">
        <p>
          ...
          Meskova, adresse communiquée sur demande légitime,
      ...
      <LegalSection title="2. Données collectées et bases légales">
        <LegalTable
          ...
          rows={[
            ...
            ['Données d’abonnement (statut, renouvellement, plateforme)', 'Gestion de l’abonnement Meskova Premium', 'Exécution du contrat', '10 ans (pièces comptables)'],
            ['Données de transaction (montant, devise, méthode tokenisée)', 'Facturation de l’abonnement', 'Exécution du contrat', 'Géré par RevenueCat/Stripe - aucune donnée carte stockée par Meskova'],
        ...
        <p>
          ...
          politiques ou religieuses.</strong> Meskova n&apos;est pas destiné aux mineurs (voir section 9).
        </p>
      </LegalSection>
      ...
      <LegalSection title="9. Public concerné et mineurs">
        <p>
          Meskova est un jeu destiné à un public adulte (17+/18+ selon les classifications des stores). Le service
          n&apos;est pas destiné aux mineurs et aucune collecte n&apos;est sciemment effectuée auprès de personnes
          de moins de 18 ans. Si Meskova prend connaissance d&apos;une inscription par un mineur, le compte
      ...
      <LegalSection title="10. Sécurité des données">
        <p>
          ...
          carte bancaire côté Meskova (délégué intégralement à Stripe, Apple et Google), journalisation limitée et
