  ...
  return (
    <LegalLayout title="CGU / CGV" version="Version applicable au 1er août 2026">
      ...
      <LegalSection title="1. Objet">
        <p>
          Les présentes CGU régissent l&apos;accès et l&apos;utilisation du service BlackOut, jeu de société
      ...
      <LegalSection title="2. Accès au service">
        <p>
          BlackOut est accessible via le site web blackout.beloucif.com (PWA) et via les applications Android et
      ...
      <LegalSection title="4. Comportement de l'utilisateur">
        <p>
          L&apos;utilisateur s&apos;engage à utiliser BlackOut de manière conforme à sa destination : un jeu de
      ...
      <LegalSection title="5. Propriété intellectuelle">
        <p>
          Le contenu des packs de jeu, les textes, illustrations, la marque BlackOut et le code source de
      ...
      <LegalSection title="7. Responsabilité">
        <p>
          BlackOut est un outil d&apos;animation de soirée ; l&apos;éditeur ne saurait être tenu responsable de
      ...
      <p className="font-mono text-[10px] uppercase tracking-widest text-ink-muted pt-4">
        Partie 2 - Conditions générales de vente - abonnement BlackOut Plus
      </p>

      <LegalSection title="9. Objet et description de l'offre">
        <p>
          BlackOut propose un abonnement premium optionnel, « BlackOut Plus », donnant accès à des packs de contenu
      ...
      <LegalSection title="10. Prix et paiement">
        <p>
          ...
          prestataire de la plateforme choisie (Apple, Google, ou Stripe pour le web) - BlackOut ne collecte ni ne
      ...
      <LegalSection title="11. Renouvellement automatique">
        <p>
          L&apos;abonnement BlackOut Plus se renouvelle automatiquement à échéance (mensuelle ou annuelle selon la
      ...
      <LegalSection title="12. Résiliation de l'abonnement">
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li><strong>Web (Stripe)</strong> : depuis l&apos;espace compte de l&apos;application BlackOut.</li>
        </ul>
        <p>
