...
/**
 * Mentions legales - transcription de bacchana-content/legal/mentions-legales.md (v1.14.0).
  ...
  return (
    <LegalLayout title="Mentions légales" version="Version applicable au 4 août 2026">
      ...
      <LegalSection title="2. Activité commerciale">
        <p>
          Bacchana propose un accès premium payant à vie (paiement unique, aucun abonnement) ainsi que des packs
      ...
      <LegalSection title="4. Fonctionnement du service et infrastructure technique">
        <p>
          Bacchana fonctionne intégralement en local sur l&apos;appareil de l&apos;utilisateur : aucune création
      ...
      <LegalSection title="8. Limitation de responsabilité">
        <p>
          ...
          d&apos;interruption de service. Bacchana est un outil d&apos;animation de soirée qui ne fait aucune
