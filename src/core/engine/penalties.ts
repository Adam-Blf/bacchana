import { calculatePenalty } from '@/core/coupeGorge'
import type { PenaltyResult } from '@/types'
import type { PackItem } from './types'

// Extends the CoupeGorge penalty logic to the prompt-based modes. Store-safe: the app only
 ...
 * PenaltyResult shape used by Le CoupeGorge, so the UI can render both with one component.
