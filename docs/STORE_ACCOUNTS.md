...
|---|---|---|
| Prérequis | Pièce d'identité | SIRET (ABEL LABS, INPI en pause) + D-U-N-S |
| Play : exigences de test | **12 testeurs pendant 14 jours** en test fermé avant toute prod | Aucune exigence de ce type |
| Apple | 99 USD/an, nom = « Adam Beloucif » sur le store | 99 USD/an, nom = « ABEL LABS », D-U-N-S requis |
| Migration plus tard | Possible (transfert d'apps) mais fastidieuse | - |

**Reco** : tant qu'ABEL LABS est en pause, ouvrir les deux comptes en
**personnel** pour ne pas bloquer le lancement. Le nom d'éditeur sera
« Adam Beloucif » ; le transfert vers un compte organisation ABEL LABS se fera
...
2. developer.apple.com/programs/enroll - s'inscrire en **individuel**
   (l'inscription organisation exige un D-U-N-S ABEL LABS, non disponible).
...
4. Après INPI ABEL LABS : envisager le transfert vers des comptes
