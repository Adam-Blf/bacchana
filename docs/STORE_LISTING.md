...
**Au menu :**
- 🂠 **Le Borderland** — le jeu de cartes signature : 52 à 156 cartes, 4 règles,
  des contestations qui montent jusqu'à x4… et des jokers qui renversent la table.
- 🧠 **Quitte ou Trinque** — le quiz culture G où tu cumules ta cagnotte… ou tu
  perds tout sur une question de trop.
- 🏆 **Le Podium** — le juge classe ses potes selon une question secrète ; à vous
  de deviner laquelle.
- 📣 **L'Enchère** — « Je peux en citer 8 en une minute ! » — « Tu mens ! » Chrono.
- ⚖️ **Le Procès** — chacun écrit une accusation anonyme, l'accusé se défend,
  la table vote.
- 👑 **Le Meneur**, **Action ou Vérité**, **Je n'ai jamais**, **Qui de nous**,
  **Tu préfères**, **C'est un 10 mais**, **7 Secondes**, **La Roulette**…
...
plus, ça fait perdre au Podium.

## Mots-clés (App Store, 100 car.)

`jeu de soirée,jeux entre amis,soirée,fête,cartes,gages,quiz,action vérité,party game,apéro`
...
- Nouveau look, plus lisible de loin — et le bouton retour fait enfin ce que tu attends.
