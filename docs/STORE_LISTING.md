# La Taverne - Fiche stores (ASO, prête à coller)
...
| Champ | Valeur | Car. |
|---|---|---|
| **Nom** (30) | `La Taverne - Jeux de soirée` | 27 |
...
| Champ | Valeur | Car. |
|---|---|---|
| **Titre** (30) | `La Taverne : jeux de soirée` | 27 |
...
démarre. La Taverne réunit 13 jeux de soirée dans une seule app : plus de
...
**La Taverne Pro** débloque les packs les plus corsés et se teste avec
...
1. `LA TAVERNE` - Les meilleurs jeux de soirée, servis au comptoir.
