...
- 🏆 **Le Tableau d'Honneur** - le juge classe ses potes selon une question secrète ; à vous
  de deviner laquelle.
...
- 4 nouveaux jeux : Quitte ou Trinque, Le Tableau d'Honneur, La Criée et le Pilori nouvelle formule.
- Crée tes propres règles, elles restent sur ton téléphone.
- Coupe-Gorge (ex-Borderland) : choisis ton nombre de paquets, jokers inclus.
